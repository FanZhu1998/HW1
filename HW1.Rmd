...
```{r Exercise#5, echo=TRUE, fig.width=8, message=FALSE, warning=FALSE}
...
plot(model1)
```
Interpretations on Q9 here.
The "Residual vs. Fitted" plot exhibits a relatively U-shape curve rather than a horizontal line, which implies that 
